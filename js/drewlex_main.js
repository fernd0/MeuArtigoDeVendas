      ...
      function genLocalForm () {
          var localForms = {
             ...
             'pl' : '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Opłacalne!</span> <s><span class="js_old_price price_old">' + priceMain * 2 + currencyMain + '</span></s><br> <b class="new_price js_new_price price_main">' + priceMain + currencyMain + '</b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pospiesz się, aby zamówić z rabatem, aż oferta zostanie przekazana do następnego czytelnika! <br>Oferta straci ważność po:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="submit.php" method="POST"> <select class="country_select wheel_input" name="country">' + ((!!settings.formApi && settings.formApi.isNeeded) ? formApiCode : '</select>')  + ' <label for="name" class="data_label">Twoje imię i nazwisko:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Tom Czerniak "><label for="phone" class="data_label">Numer telefonu:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+48 123456789"> <input type="hidden" name="landing" value="' + ((!!settings.formApi && settings.formApi.isNeeded) ? settings.formApi.landingValue : window.location.host) + '"> <button class="main-link" type="submit">ZAMÓWIĆ ' + settings.product + ' z 50% zniżką!</button> </form> </div><center> <h2 class="time_remains_title">Oferta ważna do (włącznie):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
              ...
              'cz' : '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Speciální nabídka</span> <s><span class="js_old_price price_old">' + priceMain * 2 + currencyMain + '</span></s><br> <b class="new_price js_new_price price_main">' + priceMain + currencyMain + '</b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Stíhnete si objednat se slevou, zatím nabídka nepřešla k jinému čtenářovi! <br>Nabídka vyprší za: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form x_order_form" action="submit.php" method="POST"> <select class="country_select wheel_input" name="country">' + ((!!settings.formApi && settings.formApi.isNeeded) ? formApiCode : '</select>')  + ' <h2 class="x_order_accepted">Objednávka <span class="x_order_id"></span> byla přijata</h2><div class="x_form_fields"><label for="name" class="data_label">Uveďte jméno a příjmení</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Pavel Smejkal"><label for="phone" class="data_label">Uveďte tel.číslo</label><div class="form_phone" id="form_phone"><div class="phone-codes-select" id="phone-codes-select"><button class="phone-codes-button"><span class="phone-codes-button-value"></span><span class="caret"></span></button><ul class="phone-codes-dropdown"></ul></div><input class="only_number" name="phone" required="" type="tel" autocomplete="tel" value="" placeholder="123 456 789"></div></div><h2 class="x_fix_phone">Po kódu země zadejte 9 číslic</h2><button class="js_submit button__text x_submit_button submit-button main-link" type="submit"> OBJEDNAT ' + settings.product + ' </button> <div class="x_spinner"> <svg width="100" height="100" stroke-dasharray="264" stroke-dashoffset="75"> <circle cx="50" cy="50" r="40" style=" fill: rgba(0, 0, 0, 0); stroke: #0299ff; stroke-width: 10; transform-origin: 50% 50%; stroke-linecap: round; "> <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0" to="360" begin="0" dur="3s" repeatCount="indefinite"/> </circle> </svg> </div><button class="js_submit button__text x_resubmit_button submit-button main-link" type="submit"> AKTUALIZOVAT ÚDAJE </button> <div class="x_duplicate"> <div class="x_small-info">Objednávka se zpracovává, počkejte na hovor konzultanta.</div><div class="x_checklist"> <ul> <li>Zkontrolujte, zda je zadané telefonní číslo správné</li><li>Vypnout tichý režim</li><li>Mobilní telefon mějte vždy po ruce</li><li>Odpovězte na neznámé číslo</li></ul> </div><div> Pokud máte dotazy ohledně založené objednávky, zavolejte na číslo, na kterém jste objednávku provedli.</div></div><div class="x_cta"> <h2 class="x_typewriter">Budeme vás kontaktovat za 5 minut</h2> <div class="x_checklist"> <ul> <li>Zkontrolujte, zda je zadané telefonní číslo správné</li><li>Vypnout tichý režim</li><li>Mobilní telefon mějte vždy po ruce</li><li>Odpovězte na neznámé číslo</li></ul> </div></div><span class="additional"> Vaše data jsou zasílána přímo výrobci. Kromě výrobce nemá k vašim údajům nikdo přístup. </span><input type="hidden" name="landing" value="' + ((!!settings.formApi && settings.formApi.isNeeded) ? settings.formApi.landingValue : window.location.host) + '"><input type="hidden" name="is_smart_form" value="true"><input type="hidden" name="country_code" value="cz"></form> </div><center> <h2 class="time_remains_title">Pozor, akce se speciální slevou trvá pouze do  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
